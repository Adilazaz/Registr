<script setup>
import { ref, onMounted, onUnmounted, onBeforeMount, defineProps } from 'vue';
...
// Хук onMounted аналогичен mounted в Vue 2
onMounted(() => {
    wrapper.value = document.getElementById('layout-dashboard');
});

// Хук onBeforeMount аналогичен created в Vue 2
onBeforeMount(() => {
    window.addEventListener("resize", resizeEventHandler);
});

// Хук onUnmounted аналогичен destroyed в Vue 2
onUnmounted(() => {
        ...
        <a-layout-header>
            <a-row type="flex">
                ...
                <a-col :span="24" :md="6">
                    ...
                    <!-- Header Breadcrumbs -->
                    <a-breadcrumb>
                        <router-link to="/"> Страницы/ </router-link>
                    ...
                    <!-- <div class="ant-page-header-heading">
                        <span class="ant-page-header-heading-title">{{ this.$route.path }}</span>
                    </div> -->
                    <!-- / Header Page Title -->
                ...
                <a-col :span="24" :md="18" class="header-control">
                    ...
                    <router-link to="/auth" class="btn-sign-in" @click="logOut">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <router-link to="/profile" class="btn-sign-in">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10C2 5.58172 5.58172 2 10 2C14.4183 2 18 5.58172 18 10ZM12 7C12 8.10457 11.1046 9 10 9C8.89543 9 8 8.10457 8 7C8 5.89543 8.89543 5 10 5C11.1046 5 12 5.89543 12 7ZM9.99993 11C7.98239 11 6.24394 12.195 5.45374 13.9157C6.55403 15.192 8.18265 16 9.99998 16C11.8173 16 13.4459 15.1921 14.5462 13.9158C13.756 12.195 12.0175 11 9.99993 11Z"
                                fill="#111827" />
